const contractAddress = "0x3C3cB2CF3aF33Ded303ada4C4C8546184B8289c9"; // Replace with your own contract address
const chain = 'polygon'; // rinkeby, polygon, or ethereum

const welcome_h1 = "Welcome to De MITO NINJA NFTs minting DApp!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'De MITO NINJA NFTs is an NFT collection owned by MITONFTs Lab, Which have a lot of real and virtual utilities. Follow us on all our social media communities today <a href="https://linktr.ee/Mitowise"  target="_blank" rel="noopener noreferrer">MITONFTs</a> Social media communities.';
const h1_presale_coming_soon = "De NINJA Drop Coming Soon!!";
...
const button_presale_mint_whitelisted = "Mint Your Special NINJA";
const button_presale_mint_not_whitelisted = "You are not Whitelisted";
const button_presale_already_minted = "Join The Community NOW";
